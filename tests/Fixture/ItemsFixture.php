...
class ItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'depth' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'height' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-08-11 13:12:00',
                'modified' => '2018-08-11 13:12:00'
            ],
        ];
        parent::init();
    }
