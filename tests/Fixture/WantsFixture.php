...
class WantsFixture extends TestFixture
{
    ...
    public $fields = [
        'want_id' => ['type' => 'integer', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-08-14 07:50:58',
                'modified' => '2018-08-14 07:50:58'
            ],
        ];
        parent::init();
    }
